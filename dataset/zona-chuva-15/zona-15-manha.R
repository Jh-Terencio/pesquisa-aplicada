...
data_zone_15_manha <- data_zone_15[data_zone_15$Shift == "Morning", ]

# Separadano uma parcela dos dados
sampled_data <- data_zone_15_manha[sample(nrow(data_zone_15_manha), size = nrow(data_zone_15_manha) * 0.2),]
