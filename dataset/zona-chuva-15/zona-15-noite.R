...
data_zone_15_noite <- data_zone_15[data_zone_15$Shift == "Night", ]

# Separadano uma parcela dos dados
sampled_data <- data_zone_15_noite[sample(nrow(data_zone_15_noite), size = nrow(data_zone_15_noite) * 0.2),]
