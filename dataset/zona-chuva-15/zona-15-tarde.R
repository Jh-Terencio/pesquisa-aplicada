...
data_zone_15_tarde <- data_zone_15[data_zone_15$Shift == "Afternoon", ]

# Separadano uma parcela dos dados
sampled_data <- data_zone_15_tarde[sample(nrow(data_zone_15_tarde), size = nrow(data_zone_15_tarde) * 0.2),]
